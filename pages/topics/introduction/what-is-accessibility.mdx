...
<figure className="my-6">
    <img src="/adapt-action.jpg" alt="People with disabilities crawl up the Capitol steps in 1990." />
    <figcaption className="mt-2">
        <a href="https://abilitymagazine.com/are-todays-politicians-prepared-for-another-capitol-climb/">The Capitol Crawl in 1990, Ability Magazine</a>
    </figcaption>
</figure>
